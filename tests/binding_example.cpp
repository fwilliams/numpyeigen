...
// at *compile time*. They are always named NPE_PY_TYPE_<varname> where 'varname' is the name of the
// numpy overloaded variable.
//
// An example struct for the variable 'a' is:
// struct NPE_PY_TYPE_a {
...
//   typedef Eigen::Map<NPE_PY_TYPE_a::Eigen_Type, NPE_PY_TYPE_a::Aligned> Map_Type; // The Eigen::Map
// };
...
typedef NPE_PY_TYPE_d::Scalar Scalar_d;
typedef NPE_PY_TYPE_d::Eigen_Type Matrix_d;
typedef NPE_PY_TYPE_d::Map_Type Map_d;

typedef NPE_PY_TYPE_d::Scalar Scalar_e;
typedef NPE_PY_TYPE_d::Eigen_Type Matrix_e;
typedef NPE_PY_TYPE_d::Map_Type Map_e;
...
return std::make_tuple(NPE_MOVE(Matrix_a, ret1), NPE_MOVE(Matrix_c, ret2));
