...
#ifndef CRAZY_BINDING2_H
#define CRAZY_BINDING2_H

std::tuple<int, int> crazier_ass_branching_cot_matrix(py::array v, py::array f) {
  using namespace std;
  ...
  // CM - CM
  if (tid1 == type_f32_cm && tid2 == type_i8_cm) {
    ...
    Eigen::Map<Type_i8_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_cm && tid2 == type_i16_cm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i16_cm::Scalar* f_data = (Type_i16_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_i16_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_cm && tid2 == type_i32_cm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
  ...
  else if (tid1 == type_f32_cm && tid2 == type_u8_cm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_cm::Scalar* f_data = (Type_u8_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_cm && tid2 == type_u16_cm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_cm::Scalar* f_data = (Type_u16_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  ...
  // RM - RM
  else if (tid1 == type_f32_rm && tid2 == type_i8_rm) {
    ...
    Eigen::Map<Type_i8_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_rm && tid2 == type_i16_rm) {
    Type_f32_rm::Scalar* v_data = (Type_f32_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i16_rm::Scalar* f_data = (Type_i16_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_i16_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  ...
  else if (tid1 == type_f32_rm && tid2 == type_u8_rm) {
    Type_f32_rm::Scalar* v_data = (Type_f32_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_rm::Scalar* f_data = (Type_u8_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_rm && tid2 == type_u16_rm) {
    Type_f32_rm::Scalar* v_data = (Type_f32_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_rm::Scalar* f_data = (Type_u16_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  ...
  // RM - CM
  else if (tid1 == type_f32_rm && tid2 == type_i8_cm) {
    Type_f32_rm::Scalar* v_data = (Type_f32_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i8_cm::Scalar* f_data = (Type_i8_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_i8_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_rm && tid2 == type_i16_cm) {
    Type_f32_rm::Scalar* v_data = (Type_f32_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i16_cm::Scalar* f_data = (Type_i16_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_i16_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  else if (tid1 == type_f32_rm && tid2 == type_u8_cm) {
    Type_f32_rm::Scalar* v_data = (Type_f32_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_cm::Scalar* f_data = (Type_u8_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_rm && tid2 == type_u16_cm) {
    Type_f32_rm::Scalar* v_data = (Type_f32_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_cm::Scalar* f_data = (Type_u16_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  // CM - RM
  else if (tid1 == type_f32_cm && tid2 == type_i8_rm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i8_rm::Scalar* f_data = (Type_i8_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_i8_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_cm && tid2 == type_i16_rm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i16_rm::Scalar* f_data = (Type_i16_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_i16_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  else if (tid1 == type_f32_cm && tid2 == type_u8_rm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_rm::Scalar* f_data = (Type_u8_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f32_cm && tid2 == type_u16_rm) {
    Type_f32_cm::Scalar* v_data = (Type_f32_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f32_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_rm::Scalar* f_data = (Type_u16_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  else if (tid1 == type_f64_cm && tid2 == type_u8_cm) {
    Type_f64_cm::Scalar* v_data = (Type_f64_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_cm::Scalar* f_data = (Type_u8_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f64_cm && tid2 == type_u16_cm) {
    Type_f64_cm::Scalar* v_data = (Type_f64_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_cm::Scalar* f_data = (Type_u16_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  else if (tid1 == type_f64_rm && tid2 == type_u8_rm) {
    Type_f64_rm::Scalar* v_data = (Type_f64_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_rm::Scalar* f_data = (Type_u8_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f64_rm && tid2 == type_u16_rm) {
    Type_f64_rm::Scalar* v_data = (Type_f64_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_rm::Scalar* f_data = (Type_u16_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  // RM - CM
  else if (tid1 == type_f64_rm && tid2 == type_i8_cm) {
    Type_f64_rm::Scalar* v_data = (Type_f64_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i8_cm::Scalar* f_data = (Type_i8_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_i8_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f64_rm && tid2 == type_i16_cm) {
    Type_f64_rm::Scalar* v_data = (Type_f64_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i16_cm::Scalar* f_data = (Type_i16_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_i16_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  else if (tid1 == type_f64_rm && tid2 == type_u8_cm) {
    Type_f64_rm::Scalar* v_data = (Type_f64_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_cm::Scalar* f_data = (Type_u8_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f64_rm && tid2 == type_u16_cm) {
    Type_f64_rm::Scalar* v_data = (Type_f64_rm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_rm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_cm::Scalar* f_data = (Type_u16_cm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_cm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  // CM - RM
  else if (tid1 == type_f64_cm && tid2 == type_i8_rm) {
    Type_f64_cm::Scalar* v_data = (Type_f64_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i8_rm::Scalar* f_data = (Type_i8_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_i8_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f64_cm && tid2 == type_i16_rm) {
    Type_f64_cm::Scalar* v_data = (Type_f64_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_i16_rm::Scalar* f_data = (Type_i16_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_i16_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
  ...
  else if (tid1 == type_f64_cm && tid2 == type_u8_rm) {
    Type_f64_cm::Scalar* v_data = (Type_f64_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u8_rm::Scalar* f_data = (Type_u8_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u8_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
    return std::make_tuple<int, int>(V.rows(), F.rows());
  } else if (tid1 == type_f64_cm && tid2 == type_u16_rm) {
    Type_f64_cm::Scalar* v_data = (Type_f64_cm::Scalar*)(v.data(0));
    Eigen::Map<Type_f64_cm, Eigen::Aligned> V(v_data, v_shape0, v_shape1);
    Type_u16_rm::Scalar* f_data = (Type_u16_rm::Scalar*)(f.data(0));
    Eigen::Map<Type_u16_rm, Eigen::Aligned> F(f_data, f_shape0, f_shape1);
