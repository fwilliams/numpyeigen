...
#ifndef CRAZY_BINDING4_H
#define CRAZY_BINDING4_H

namespace py = pybind11;

std::tuple<int, int, int, int, int>
krazi_ass_branching_cot_matrix(py::array v1, py::array v2, py::array v3, py::array v4) {
  using namespace std;
...
//  long int v6_strides[2] = { v6.strides()[0], v6.strides()[1] };
  ...
  #include "codegen4.inc"

  //  return L.rows();
}


#endif // CRAZY_BINDING4_H
