...
pybind11::object move(T& ret) {
  return pybind11::reinterpret_steal<pybind11::object>(pybind11::detail::eigen_encapsulate<pybind11::detail::EigenProps<T>>(new T(std::move(ret))));
}

template <typename T, typename std::enable_if<is_eigen_dense_map<T>::value>::type* = nullptr>
pybind11::object move(T& ret) {
  return pybind11::reinterpret_steal<pybind11::object>(pybind11::detail::eigen_encapsulate_dense_map<pybind11::detail::EigenProps<T>>(new T(std::move(ret))));
}
